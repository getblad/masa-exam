...
This code took places as number of digit and input as number placed at the right and then fill all other places with zeroes. If input is greater (in terms of places)than number of places than returns input.
